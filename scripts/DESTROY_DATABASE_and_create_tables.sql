...
-- Fri 03 May 2019 02:57:32 PM -03
...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `scientiometer` ;
...
CREATE TABLE IF NOT EXISTS `scientiometer`.`scientometric_index` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `researcher_employee_id` INT NOT NULL,
  `n_citations_wos` INT NULL,
  `h_index_wos` INT NULL,
  `n_citations_gs` INT NULL,
  `h_index_gs` INT NULL,
...
CREATE TABLE IF NOT EXISTS `scientiometer`.`advising` (
  ...
  `validity_start` YEAR(4) NOT NULL,
  `validity_end` YEAR(4) NULL,
  `postdoc_supervisor` VARCHAR(100) NULL,
  ...
  PRIMARY KEY (`intern_id`, `researcher_id`, `internship_level_id`),
...
CREATE TABLE IF NOT EXISTS `scientiometer`.`supervision` (
  ...
  INDEX `fk_supervision_advising1_idx` (`advising_intern_id` ASC, `advising_researcher_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_supervision_supervision_type1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_supervision_advising1`
...
-- -----------------------------------------------------
-- Table `scientiometer`.`active_grant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scientiometer`.`active_grant` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `granted_researcher_id` INT NOT NULL,
  ...
  `validity_end` YEAR(4) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_active_grant_researcher1_idx` (`granted_researcher_id` ASC) VISIBLE,
  INDEX `fk_active_grant_project_type1_idx` (`project_type_id` ASC) VISIBLE,
  INDEX `fk_active_grant_participation_type1_idx` (`participation_type_id` ASC) VISIBLE,
  INDEX `fk_active_grant_aid_agency1_idx` (`funding_agency_id` ASC) VISIBLE,
  CONSTRAINT `fk_active_grant_researcher1`
    FOREIGN KEY (`granted_researcher_id`)
    REFERENCES `scientiometer`.`researcher` (`employee_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_active_grant_project_type1`
    FOREIGN KEY (`project_type_id`)
    REFERENCES `scientiometer`.`project_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_active_grant_participation_type1`
    FOREIGN KEY (`participation_type_id`)
    REFERENCES `scientiometer`.`participation_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_active_grant_funding_agency1`
    FOREIGN KEY (`funding_agency_id`)
    REFERENCES `scientiometer`.`funding_agency` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `scientiometer`.`scholarship` (
  ...
  `advising_researcher_id` INT NOT NULL,
  `advising_intern_id` INT NOT NULL,
  `advising_level_id` INT NULL,
  `process_number` VARCHAR(45) NULL,
  `total_value_BRL` DECIMAL(20,2) NULL,
  `total_value_USD` DECIMAL(20,2) NULL,
  `technical_reserve_BRL` DECIMAL(20,2) NULL,
  `year` YEAR(4) NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_scholarship_level1_idx` (`advising_level_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_scholarship_advising1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_scholarship_level1`
    FOREIGN KEY (`advising_level_id`)
    REFERENCES `scientiometer`.`advising` (`intern_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `scientiometer`.`cultural_activity` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `researcher_employee_id` INT NOT NULL,
  `participation_type` VARCHAR(1000) NOT NULL,
  `duration` INT NULL,
  `year` YEAR(4) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `scientiometer`.`service_provision` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `researcher_employee_id` INT NOT NULL,
  `service_provisioned` VARCHAR(1000) NOT NULL,
  `duration` INT NULL,
  `year` YEAR(4) NOT NULL,
  PRIMARY KEY (`id`),
